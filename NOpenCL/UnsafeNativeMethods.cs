namespace NOpenCL
{
    ...
    internal static partial class UnsafeNativeMethods
    {
        ...
        [DllImport(ExternDll.OpenCL)]
        public static extern ErrorCode clGetEventProfilingInfo(EventSafeHandle @event, int paramName, UIntPtr paramValueSize, IntPtr paramValue, out UIntPtr paramValueSizeRet);
